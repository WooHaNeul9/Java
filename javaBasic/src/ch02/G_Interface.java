...
interface AreaCalculation {
	...
	public abstract double getSquare(double side);
...
public class G_Interface {
	...
	public static void main(String[] args) {		
		...
		AreaCalculation instance1 = new MyMathV2();
