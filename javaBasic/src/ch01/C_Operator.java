...
public class C_Operator {
	...
	public static void main(String[] args) {
		...
		System.out.println(b); // 결과값 : 7 => 앞의 비교 연산이 false이기 때문에 결과값은 7이 나옴
		
		booleanResult = (a > b) && (a > ++b);
		System.out.println(booleanResult); // 결과값 : ture
		System.out.println(b); // 결과값 : 8 => 앞의 비교 연산이 true이기 때문에 결과값은 8이 나옴
		
		booleanResult = (a > b) || (a > ++b);
		System.out.println(booleanResult); // 결과값 : true
		System.out.println(b); // 결과값 : 8 => 앞의 비교 연산이 true이기 때문에 뒤의 비교 연산은 읽지 않음
		
		booleanResult = (a < b) || (a > ++b);
		System.out.println(booleanResult); // 결과값 : true
		System.out.println(b); // 결과값 : 9 => 앞의 비교 연산이 false이기 때문에 뒤의 비교 연산은 읽어서 결과가 9로 나타남
		...
		String stringResult = age > 19 ? "성인" : "미성년자"; // String : 참조형 데이터 타입, 문자열을 담아주는 변수
